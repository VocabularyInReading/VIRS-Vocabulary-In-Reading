webpackJsonp(["text-statistics.module"],{
...
/***/ "./src/app/layout/text-statistics/text-statistics-routing.module.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TextStatisticsRoutingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_router__ = __webpack_require__("./node_modules/@angular/router/@angular/router.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__text_statistics_component__ = __webpack_require__("./src/app/layout/text-statistics/text-statistics.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_2__text_statistics_component__["a" /* TextStatisticsComponent */] }
];
var TextStatisticsRoutingModule = (function () {
    function TextStatisticsRoutingModule() {
    }
    return TextStatisticsRoutingModule;
}());
TextStatisticsRoutingModule = __decorate([
...
//# sourceMappingURL=text-statistics-routing.module.js.map

/***/ }),

/***/ "./src/app/layout/text-statistics/text-statistics.component.html":
/***/ (function(module, exports) {
...
/***/ "./src/app/layout/text-statistics/text-statistics.component.scss":
/***/ (function(module, exports) {
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TextStatisticsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
...
var TextStatisticsComponent = TextStatisticsComponent_1 = (function () {
    function TextStatisticsComponent(_textService, router, _location, modal) {
        this._textService = _textService;
        this.router = router;
        this._location = _location;
        this.modal = modal;
        this.pieChartLabels = ['Stem Word %', 'Academic Word %', 'Other High Freq. %', 'Medium Freq. %', 'Low Freq. %', 'Names & Off-List %', 'K1 %', 'K2 %', 'K3 %'];
        this.pieChartType = 'pie';
        this.barChartOptions = {
            scaleShowVerticalLines: false,
            responsive: true
        };
        this.barChartLabels = ['Stem Word', 'Academic Word', 'Other High Freq.', 'Medium Freq.', 'Low Freq.', 'Off-List', 'K1', 'K2', 'K3'];
        ...
        this.backLabel = TextStatisticsComponent_1.BACK_LABEL;
        this.enhanceTextLabel = TextStatisticsComponent_1.ENHANCETEXT_LABEL;
    }
    TextStatisticsComponent.prototype.ngOnInit = function () {
        window.scrollTo(0, 0);
        ...
        if (!this.text) {
            ...
            this.updateBarChart(this.text.statistics.wordCount.stem, this.text.statistics.wordCount.awl, this.text.statistics.wordCount.hi, this.text.statistics.wordCount.med, this.text.statistics.wordCount.low, this.text.statistics.wordCount.noCategory, this.text.statistics.wordCount.k1, this.text.statistics.wordCount.k2, this.text.statistics.wordCount.k3);
            this.updatePieChart(this.text.statistics.wordPercentage.stem, this.text.statistics.wordPercentage.awl, this.text.statistics.wordPercentage.hi, this.text.statistics.wordPercentage.med, this.text.statistics.wordPercentage.low, this.text.statistics.wordPercentage.noCategory, this.text.statistics.wordPercentage.k1, this.text.statistics.wordPercentage.k2, this.text.statistics.wordPercentage.k3);
        }
    };
    /*
      ...
      0--29: College Level
    */
    TextStatisticsComponent.prototype.textLevel = function (score, words) {
        if (score <= 29 && score >= 1) {
    ...
    TextStatisticsComponent.prototype.backClicked = function () {
        this._location.back();
    };
    TextStatisticsComponent.prototype.onResize = function (event) {
        this.showOnlyIcons = window.innerWidth <= 680;
        this.updaTeLabels();
        event.target.innerWidth;
    };
    TextStatisticsComponent.prototype.updaTeLabels = function () {
        this.backLabel = this.showOnlyIcons ? '' : TextStatisticsComponent_1.BACK_LABEL;
        this.enhanceTextLabel = this.showOnlyIcons ? '' : TextStatisticsComponent_1.ENHANCETEXT_LABEL;
    };
    // events for Pie Chart
    TextStatisticsComponent.prototype.chartClicked = function (e) {
        console.log(e);
    };
    TextStatisticsComponent.prototype.chartHovered = function (e) {
        console.log(e);
    };
    // Update Pie chart
    TextStatisticsComponent.prototype.updateBarChart = function (stem, awl, hi, med, low, noCategory, K1, K2, K3) {
        this.barChartData = [
            { data: [stem, awl, hi, med, low, noCategory, K1, K2, K3], label: '# of Words in different Category' },
        ];
    };
    TextStatisticsComponent.prototype.updatePieChart = function (stem, awl, hi, med, low, noCategory, K1, K2, K3) {
    ...
    TextStatisticsComponent.prototype.open = function (content) {
        var _this = this;
        console.log('opened');
    ...
    TextStatisticsComponent.prototype.getDismissReason = function (reason) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TextStatisticsModule", function() { return TextStatisticsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common__ = __webpack_require__("./node_modules/@angular/common/@angular/common.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__("./node_modules/@angular/forms/@angular/forms.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__text_statistics_routing_module__ = __webpack_require__("./src/app/layout/text-statistics/text-statistics-routing.module.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__text_statistics_component__ = __webpack_require__("./src/app/layout/text-statistics/text-statistics.component.ts");
...
var TextStatisticsModule = (function () {
    function TextStatisticsModule() {
    }
    return TextStatisticsModule;
}());
TextStatisticsModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        imports: [
            __WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */],
            __WEBPACK_IMPORTED_MODULE_3__text_statistics_routing_module__["a" /* TextStatisticsRoutingModule */],
            __WEBPACK_IMPORTED_MODULE_2__angular_forms__["a" /* FormsModule */],
            __WEBPACK_IMPORTED_MODULE_6_ng2_charts__["ChartsModule"],
            __WEBPACK_IMPORTED_MODULE_5__ng_bootstrap_ng_bootstrap__["f" /* NgbModule */].forRoot()
        ],
        declarations: [__WEBPACK_IMPORTED_MODULE_4__text_statistics_component__["a" /* TextStatisticsComponent */]]
    })
], TextStatisticsModule);

//# sourceMappingURL=text-statistics.module.js.map

/***/ })

});
//# sourceMappingURL=text-statistics.module.chunk.js.map