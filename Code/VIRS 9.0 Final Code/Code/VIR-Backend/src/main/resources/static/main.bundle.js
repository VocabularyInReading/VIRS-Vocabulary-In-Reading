...
var map = {
	...
	"./download-words/download-words.module": [
		"./src/app/layout/download-words/download-words.module.ts",
		"download-words.module"
	],
	...
	"./search-words/search-words.module": [
...
var SidebarComponent = (function () {
    ...
    SidebarComponent.prototype.copyMessage = function (val) {
        var _this = this;
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "DownloadListService", function() { return __WEBPACK_IMPORTED_MODULE_4__services__["c"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "TextService", function() { return __WEBPACK_IMPORTED_MODULE_4__services__["d"]; });
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "WordsListService", function() { return __WEBPACK_IMPORTED_MODULE_4__services__["e"]; });
...
/***/ "./src/app/shared/services/downloadList.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return DownloadListService; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("./node_modules/@angular/core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_common_http__ = __webpack_require__("./node_modules/@angular/common/@angular/common/http.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var DownloadListService = (function () {
    function DownloadListService(http) {
        this.http = http;
    }
    DownloadListService.prototype.downloadWordList = function (categories) {
        // console.log(`/api/download/${categories}`);
        // return this.http.get<any>(`/api/download/${categories}`);
        // .do((res) => console.log(res));
        fetch("/api/download/" + categories).then(function (response) {
...
DownloadListService = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */]) === "function" && _a || Object])
], DownloadListService);

var _a;
//# sourceMappingURL=downloadList.service.js.map
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_0__text_service__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "e", function() { return __WEBPACK_IMPORTED_MODULE_1__wordsList_service__["a"]; });
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "f", function() { return __WEBPACK_IMPORTED_MODULE_4__iTranslate_service__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__downloadList_service__ = __webpack_require__("./src/app/shared/services/downloadList.service.ts");
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "c", function() { return __WEBPACK_IMPORTED_MODULE_5__downloadList_service__["a"]; });
...
var WordsListService = (function () {
    ...
    WordsListService.prototype.getLiveWordList = function (pageNumber, category, size, sort, value) {
        if (pageNumber === void 0) { pageNumber = 0; }
        if (value == null)
            return this.http.get("/api/words?category=" + category + "&page=" + pageNumber + "&size=" + size + "&sortKey=value&sortDirection=" + sort);
        return this.http.get("/api/words/valueandcat?value=" + value + "&category=" + category + "&page=" + pageNumber + "&size=" + size + "&sortKey=value&sortDirection=" + sort)
            .do((function (res) { return console.log("Response:", res); }));
    };
    // To get word ID, Value and Category
