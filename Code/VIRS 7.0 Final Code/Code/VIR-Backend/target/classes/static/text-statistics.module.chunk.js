...
var TextStatisticsComponent = TextStatisticsComponent_1 = (function () {
    function TextStatisticsComponent(_textService, router, _location, modal) {
        ...
        this.modal = modal;
        this.pieChartLabels = ['Stem Word', 'Academic Word', 'Other High Freq.', 'Medium Freq.', 'Low Freq.', 'Names & Off-List', 'K1', 'K2'];
        this.pieChartType = 'pie';
        this.barChartOptions = {
            scaleShowVerticalLines: false,
            responsive: true
        };
        this.barChartLabels = ['Stem Word', 'Academic Word', 'Other High Freq.', 'Medium Freq.', 'Low Freq.', 'Off-List', 'K1', 'K2'];
    ...
    TextStatisticsComponent.prototype.ngOnInit = function () {
        ...
        if (!this.text) {
            ...
            this.updateBarChart(this.text.statistics.wordCount.stem, this.text.statistics.wordCount.awl, this.text.statistics.wordCount.hi, this.text.statistics.wordCount.med, this.text.statistics.wordCount.low, this.text.statistics.wordCount.noCategory, this.text.statistics.wordCount.k1, this.text.statistics.wordCount.k2);
            this.updatePieChart(this.text.statistics.wordPercentage.stem, this.text.statistics.wordPercentage.awl, this.text.statistics.wordPercentage.hi, this.text.statistics.wordPercentage.med, this.text.statistics.wordPercentage.low, this.text.statistics.wordPercentage.noCategory, this.text.statistics.wordPercentage.k1, this.text.statistics.wordPercentage.k2);
        }
    };
    /*
    ...
    */
    ...
    // Update Pie chart
    TextStatisticsComponent.prototype.updateBarChart = function (stem, awl, hi, med, low, noCategory, K1, K2) {
        this.barChartData = [
            { data: [stem, awl, hi, med, low, noCategory, K1, K2], label: '# of Words in different Category' },
        ];
    };
    TextStatisticsComponent.prototype.updatePieChart = function (stem, awl, hi, med, low, noCategory, K1, K2) {
