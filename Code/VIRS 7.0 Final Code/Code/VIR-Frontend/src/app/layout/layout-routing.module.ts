...
const routes: Routes = [
    {
        ...
        children: [
            ...
            { path: "image", loadChildren: "./image/image.module#ImageModule" },
            {
                ...
                loadChildren:
                    "./enhanced-text-result/enhanced-text-result.module#EnhancedTextResultModule",
            },
            {
            ...
            },
            {
                path: "search-words",
                loadChildren:
                    "./search-words/search-words.module#SearchWordsModule",
            },
            {
                path: "download-words",
                loadChildren:
                    "./download-words/download-words.module#DownloadWordsModule",
            },
            {
                path: "restore",
